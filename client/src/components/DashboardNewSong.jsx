...
export const ImageLoader = ({progress}) => {
    return (
        <div className="w-full h-full flex flex-col items-center justify-center">
            ...
            <div
                className="w-20 h-20 min-w-[40px] bg-red-600  animate-ping  rounded-full flex items-center justify-center relative">
        ...
        <label>
            <div className="flex flex-col items-center justify-center h-full">
                <div className="flex flex-col justify-center items-center cursor-pointer">
                    ...
                    <p className="text-lg">
                        Нажми для загрузки {isImage ? "image" : "audio"}
                    </p>
                </div>
            </div>
            <input
...
export const AddNewArtist = () => {
    ...
    return (
        <div className="flex items-center justify-evenly w-full flex-wrap">
            <div
                className="bg-card  backdrop-blur-md w-full lg:w-225 h-225 rounded-md border-2 border-dotted border-gray-300 cursor-pointer">
